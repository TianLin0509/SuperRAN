...
_EDITABLE: tuple[tuple[str, str, str, Any, str], ...] = (
    ...
    ("runtime_cqi_enabled", "运行时 CQI 事件", "select", ["on", "off"],
     "默认 on；off 精确退回建表阶段的离线 CQI，用于回归对照"),
    ...
    state = {
        ...
        "impact": {
            ...
            "link": ["precoder", "power_constraint", "neighbor_prb_util",
                     ...
                     "csi_report_period_ms", "runtime_cqi_enabled",
                     "rb_power_control_enabled",
