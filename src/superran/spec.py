...
_EDITABLE: tuple[tuple[str, str, str, Any, str], ...] = (
    ...
    ("rank_switch_se_ratio", "Rank 切换谱效比门限", "number", (1.0, 3.0, 0.01),
     "最优/当前 的滤波谱效比要超过它才切换；这就是防乒乓的迟滞"),
    ...
    ("cqi_filter_lambda", "CQI 滤波系数 λ", "number", (0.01, 1.0, 0.01),
     "一阶 IIR：CQI ← CQI + λ(最新测量 − CQI)。λ=1 不滤波；默认 0.25 是"
     "工程默认，待现场标定"),
