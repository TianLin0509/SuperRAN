...
<div class="card"><h3>本地源码</h3><div class="path">src/superran/native.py<br>src/superran/physical.py<br>src/superran/spec38901.py<br>src/superran/generate.py<br>src/superran/channelhub.py<br>src/superran/system.py</div></div></div>
