...
<tr><td><b>把历史表行0和上报4-bit CQI0混为一谈</b></td>
<td>低信道样本可能被当成MCS0可调度用户</td>
<td>现在同时保留两套编号：历史表行0..14用于兼容，上报codepoint 0..15
用于协议语义。表行0对应上报CQI1并映射MCS0；上报CQI0是out-of-range，必须不调度。</td></tr>
